...
namespace Winton.DomainModelling.DocumentDb
{
    ...
    public class EntityPersistenceTests : IDisposable
    {
        ...
        public EntityPersistenceTests()
        {
            ...
            var database = new Database { Id = nameof(EntityPersistenceTests) };
            var documentCollection = new DocumentCollection { Id = nameof(EntityPersistenceTests) };
        ...
        public sealed class Create : EntityPersistenceTests
        {
            [Fact]
        ...
        public sealed class Upsert : EntityPersistenceTests
        {
            [Fact]
